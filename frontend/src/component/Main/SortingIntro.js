      ...
      <CardActionArea disableRipple="true" disabled="true"> 
        ...
        <CardContent>
          ...
          <Typography variant="body1" color="textSecondary" component="p">
            Sorting is one of the fundamental of Algorithms, but is hard to grasp the concept with actually seeing
            the process of sorting, here, we provide a tool for you, demonstrate the detail of all kinds of sort, from 
            basic selection sort, to advance bogo sort. 
          </Typography>
        </CardContent>
      </CardActionArea>
      <CardActions>
