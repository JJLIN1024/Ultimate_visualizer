            ...
            <ul id="mainBST">
                ...
                <li className="dropdown">
                    ...
                    <div className="dropdown-content">
                        <ul>
                            <li>
                                <button onClick={() => props.traversal("inorder")}>Inorder</button>
                            </li>
                            <li>
                                <button onClick={() => props.traversal("preorder")}>Preorder</button>
                            </li>
                            <li>
                                <button onClick={() => props.traversal("postorder")}>Postorder</button>
                            </li>
                        </ul>
                    </div>
                </li>
