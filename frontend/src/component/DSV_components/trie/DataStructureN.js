...
class nodeTrie {
    constructor(key) {
        ...
        this.html = (
            <li key={this.key}>
                ...
                {this.childrenHtml.length ? <ul>{this.childrenHtml}</ul> : null}
            </li>
        );
    }
    ...
    updateHtml() {
        ...
        this.html = (
            <li key={this.key}>
                <div className={this.isEnd ? "normal end" : "normal"}>{this.key ? this.key : "Root"}</div>
                {this.childrenHtml.length ? <ul>{this.childrenHtml}</ul> : null}
            </li>
        );
    ...
    HighlightHtml() {
        ...
        this.html = (
            <li key={this.key}>
                <div className={this.isEnd ? "normal highlight end" : "normal highlight"}>
