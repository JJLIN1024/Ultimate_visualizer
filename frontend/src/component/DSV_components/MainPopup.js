    ...
    return (
        <div className="popup main">
            <div className="inner">
                ...
                <div>
                    This part's aim is to visualize various data structures. <br />
                    ...
                    To learn various visualization features of each section, click on{" "}
                    <HelpIcon width="25px" height="25px" /> at the top.
                </div>
            </div>
        </div>
    );
